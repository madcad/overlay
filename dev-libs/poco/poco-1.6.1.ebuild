...
SRC_URI="http://pocoproject.org/releases/poco-$(get_version_component_range 1-3)/${MY_P}-all.tar.bz2
	doc? ( http://pocoproject.org/releases/poco-$(get_version_component_range 1-3)/${MY_DOCP}.zip )"
LICENSE="Boost-1.0"
SLOT="0"
KEYWORDS="amd64 arm x86"
IUSE="doc examples iodbc mysql odbc sqlite ssl test mongodb"
